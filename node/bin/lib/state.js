...
var engineReader_1 = require("./engineReader");
var daiReader_1 = require("./daiReader");
var pollenium_xanthoceras_1 = require("pollenium-xanthoceras");
var maker_1 = require("./maker");
function fetchState() {
    return __awaiter(this, void 0, void 0, function () {
        var engineBalance, nativeBalance, allowance;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, engineReader_1.engineReader.fetchBalance({
                        token: pollenium_xanthoceras_1.dai,
                        holder: maker_1.maker
                    })];
                case 1:
                    engineBalance = _a.sent();
                    return [4 /*yield*/, daiReader_1.daiReader.fetchBalance(maker_1.maker)];
                case 2:
                    nativeBalance = _a.sent();
                    return [4 /*yield*/, daiReader_1.daiReader.fetchAllowance({
                            holder: maker_1.maker,
...
function logState() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchState()];
                case 1:
                    state = _a.sent();
                    console.log('================');
